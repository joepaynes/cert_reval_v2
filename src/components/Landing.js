    ...
    return (
      <section className="video-section">
            <video className="background-video" autoPlay muted loop>
                <source src="img//Certify - Cover.mp4" type="video/mp4" />
                {/* <source src="assets/img/Industrial_Brooklyn.webm" type="video/webm" /> */}
            ...
            <div className="jumbotron-container">
                <div className="jumbotron">
                    <h1 className="header-massive">Your Certificates</h1>
                    <h1 className="header-sub-massive">managed and tracked in one place </h1>
                </div>
            </div>
        </section>
    );
