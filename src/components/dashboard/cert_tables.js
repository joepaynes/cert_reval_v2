        ...
        return (
            <tr className="cert" key={cert.no}>
                ...
                <td>
                    <div className="progress-bar">
                        ...
                        <div className="progress-bar__bar">
                            ...
                            <div className="progress-bar__bar--value" style={{width: percentage + "%"}}>
                            </div>
                        </div>
                    </div>
                </td>
                <td className="align-center">
                    ...
                    <button onClick={()=>{self.props.delete(cert.name)}} className="button-text"><div className="button-text__content"><Delete />Delete</div></button>
                    <button onClick={() => {self.props.download(cert.fileName);}} className="button-text"><div className="button-text__content">Download</div></button>
                </td>
            </tr>
        )
    })
